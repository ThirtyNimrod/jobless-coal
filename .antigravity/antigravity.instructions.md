# Repository Instructions for AntiGravity
...
- Optimized for AntiGravity's lightweight, fast-paced editing environment.
- Support for rapid iteration and collaborative code review.
- Integration with AntiGravity's project management features.
